  ...
  return (
    <div className="min-h-screen font-sans bg-[#2b2b2b]  flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center py-2">
        <button>
          <div className="text-center font-bold text-lg text-[#f8f0f0] bg-[#6d8a55] rounded-lg p-12 w-[500px] max-w-full shadow-md transition transform active:scale-95 duration-150 ease-in-out">
            <p>Device</p>
          </div>
        </button>
